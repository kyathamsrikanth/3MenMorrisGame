...
public class PlayerOne implements Runnable {
    ...
    private void makeMove() {
        ...
        MoveData randomPoint = getRandomPoint();
        Game.movePiece(pieces[pieceNumber], randomPoint);
    }
    private void placePiece() {
        pieces[numPieces] = getRandomPoint();
        Game.movePiece(new MoveData(-1,-1,Constants.PLAYER_One_ID), pieces[numPieces]);
        numPieces++;
    }
    ...
    private MoveData getRandomPoint() {
        ...
        return new MoveData(move[0], move[1], Constants.PLAYER_One_ID);
    }
